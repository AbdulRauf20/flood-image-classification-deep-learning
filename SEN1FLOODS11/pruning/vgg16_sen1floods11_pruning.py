# ╔══════════════════════════════════════════════════════════════════════╗
#  SEN1FLOODS11 — VGG-16 LIGHTWEIGHT STUDY: Params, FLOPs & PRUNING
#  Companion to baselines/vgg16_sen1floods11_baselines.py
#
#  Team-lead request:
...
#        b) STRUCTURED L1 pruning — whole conv filters AND whole neurons
#           of the two hidden 4096-wide FC layers (20/40/60%).
#           VGG-specific: ~90% of VGG-16's 134M params live in the FC
#           head, so structured pruning must include it to cut params.
