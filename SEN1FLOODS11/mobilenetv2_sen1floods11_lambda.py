...
#  Same Algorithm 1 + λ technique as the other SEN1FLOODS11 runs:
#  λ swept from 0.0 → 1.0 (step 0.1) — 50 epochs per λ
#  (FloodNet MobileNetV2 run used fixed λ=0.2; set
#   LAMBDA_VALUES = [0.2] below to reproduce that exact behaviour.)
...
#     MobileNetV2 input distribution matches the FloodNet setup.
